...
import atelier.manichino.repository.RoleRepository;
import atelier.manichino.repository.UserRepository;
import atelier.manichino.requests.LoginRequest;
import atelier.manichino.requests.SignupRequest;
import atelier.manichino.responses.JwtResponse;
import atelier.manichino.responses.MessageResponse;
import atelier.manichino.security.JwtUtils;
import atelier.manichino.security.service.impl.UserDetailsImpl;

@CrossOrigin(origins = "*", maxAge = 3600)
@RestController
@RequestMapping("/manichino/auth")
